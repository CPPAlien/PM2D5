...
import com.pm2d5.R;
import com.pm2d5.view.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		String pullLabel = context.getString(R.string.about);
		String refreshingLabel = context.getString(R.string.about);
		String releaseLabel = context.getString(R.string.about);
		...
		if (a.hasValue(R.styleable.PullToRefresh_pulladapterViewBackground)) {
			refreshableView.setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_pulladapterViewBackground,
					Color.WHITE));
		}
		a.recycle();
